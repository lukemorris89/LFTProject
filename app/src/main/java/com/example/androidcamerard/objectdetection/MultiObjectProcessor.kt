...
package com.example.androidcamerard.objectdetection
...
import com.example.androidcamerard.camera.CameraReticuleAnimator
import com.example.androidcamerard.camera.FrameProcessorBase
...
class MultiObjectProcessor(
    ...
    private val cameraReticleAnimator: CameraReticuleAnimator = CameraReticuleAnimator(graphicOverlay)
    ...
    override fun onSuccess(
        ...
        if (selectedObject == null) {
            ...
            graphicOverlay.add(ObjectReticuleGraphic(graphicOverlay, cameraReticleAnimator))
    ...
    private fun shouldSelectObject(graphicOverlay: ObjectDetectionGraphicOverlay, visionObject: DetectedObject): Boolean {
