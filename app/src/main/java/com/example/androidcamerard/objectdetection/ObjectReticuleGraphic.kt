 ...
 */
internal class ObjectReticuleGraphic(overlay: ObjectDetectionGraphicOverlay, private val animator: CameraReticuleAnimator) :
    ObjectDetectionGraphicOverlay.Graphic(overlay) {
