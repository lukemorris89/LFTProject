...
class CameraSource(private val graphicOverlay: ObjectDetectionGraphicOverlay) {
    ...
    private inner class FrameProcessingRunnable internal constructor() : Runnable {
        ...
        override fun run() {
            ...
            while (true) {
                ...
                try {
                    synchronized(processorLock) {
                        val frameMetadata = ObjectDetectionFrameMetadata(previewSize!!.width, previewSize!!.height, rotationDegrees)
                        data?.let {
