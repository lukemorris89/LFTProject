 ...
 */
class ObjectDetectionGraphicOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
     ...
     * instances to the overlay using [ObjectDetectionGraphicOverlay.add].
     */
    abstract class Graphic protected constructor(protected val overlay: ObjectDetectionGraphicOverlay) {
